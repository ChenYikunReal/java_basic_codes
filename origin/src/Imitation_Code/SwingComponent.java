...
public class SwingComponent {
    ...
    //定义一个按钮，并为之指定图标
    Icon okIcon = new ImageIcon("C:\\Users\\yk\\eclipse-workspace\\疯狂Java讲义\\ico\\ok.png");
    ...
    //创建“新建”菜单项，并为之指定图标
    Icon newIcon = new ImageIcon("C:\\Users\\yk\\eclipse-workspace\\疯狂Java讲义\\ico\\new.png");  
    JMenuItem newItem = new JMenuItem("新建", newIcon);
    
    //创建“保存”菜单项，并为之指定图标
    Icon saveIcon = new ImageIcon("C:\\Users\\yk\\eclipse-workspace\\疯狂Java讲义\\ico\\save.png");  
    JMenuItem saveItem = new JMenuItem("保存", saveIcon);
    
    //创建“退出”菜单项，并为之指定图标
    Icon exitIcon = new ImageIcon("C:\\Users\\yk\\eclipse-workspace\\疯狂Java讲义\\ico\\exit.png");    
    JMenuItem exitItem = new JMenuItem("退出", exitIcon);
    
    JCheckBoxMenuItem autoWrap = new JCheckBoxMenuItem("自动换行");
    
    //创建“复制”菜单项，并为之指定图标
    Icon copyIcon = new ImageIcon("C:\\Users\\yk\\eclipse-workspace\\疯狂Java讲义\\ico\\copy.png");
    JMenuItem copyItem = new JMenuItem("复制", copyIcon);
    
    //创建“粘贴”菜单项，并为之指定图标
    Icon pasteIcon = new ImageIcon("C:\\Users\\yk\\eclipse-workspace\\疯狂Java讲义\\ico\\paste.png");
    ...
    public void init() {
        ...
        //创建了一个装载了下拉选择框、三个JCheckBox的JPanel
        ...
        //创建一个水平排列的组件Box，盛装topLeft、colorList
