...
public class Gobang {
	// 下面三个位图分别代表棋盘、黑子、白子
		...
		{
			table = ImageIO.read(new File("C:\\Users\\yk\\eclipse-workspace\\疯狂Java讲义\\image\\board.jpg"));
			black = ImageIO.read(new File("C:\\Users\\yk\\eclipse-workspace\\疯狂Java讲义\\image\\black.gif"));
			white = ImageIO.read(new File("C:\\Users\\yk\\eclipse-workspace\\疯狂Java讲义\\image\\white.gif"));
			selected = ImageIO.read(new File("C:\\Users\\yk\\eclipse-workspace\\疯狂Java讲义\\image\\selected.gif"));
			// 把每个元素赋为"╋"，"╋"代表没有棋子
